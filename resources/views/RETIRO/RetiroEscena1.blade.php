...
<script language="javascript">
 ...
 function validacion(cupo,pre,obj) {
  ...
  // prerequisito 
  if(pre>0)
   if (!document.getElementById("check"+pre).checked){//si no esta checked la materia de la que es prerequi..
     obj.checked=false;
...
function retirar() {
         var miDivRetiro = document.getElementById("miTable");//
                    miDivRetiro.style.display = "none";
        var miDivBoleta = document.getElementById("miTable2");
                    miDivBoleta.style.display = "block";
        for (i=1; i<=6; i++){
                            ...
                            <tbody>
                                <div id="form1">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <span class="custom-checkbox">
                                               <input type="checkbox" id="check5" onchange="validacion(75,6, this)" />
                                                <label for="selectAll"></label>
                                            </span>
                                        </th>
                                    </tr>
